...
public class WorkflowTraceService {
    ...
    private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity, ProcessInstance processInstance,
        ...
        System.out.printf("activityBehavior={}", activityBehavior);
        ...
        System.out.printf("trace variables: {}", vars);
    ...
    private Task getCurrentTaskInfo(ProcessInstance processInstance) {
        ...
        try {
            ...
            System.out.printf("current activity id: {}", activitiId);

            currentTask = taskService.createTaskQuery().processInstanceId(processInstance.getId()).taskDefinitionKey(activitiId)
                    .singleResult();
            System.out.printf("current task for processInstance: {}", ToStringBuilder.reflectionToString(currentTask));
